<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/391137/galactic-cruise" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>T.K. King, Dennis Northcott, Koltin Thompson</dd>
        <dt>Artist</dt>
        <dd> Ian O'Toole</dd>
        <dt>Publisher</dt>
        <dd><a href="https://www.kinsonkeygames.com/" target="_blank" rel="noopener">Kinsom Key Games</a></dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/galactic-cruise-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/galactic-cruise-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/galactic-cruise-solo-helper</a></dd>
      </dl>
